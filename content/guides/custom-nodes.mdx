...
**Requires FFmpeg** → See [Guide 8](/guides/fix-dependencies)
...
**Still broken?**
→ [Guide 9: Troubleshooting Assistant](/guides/troubleshooting-assistant)

---

## 🎯 Related Guides

- [Guide 5: Workflow Errors](/guides/workflow-errors)
- [Guide 8: Missing Dependencies](/guides/fix-dependencies)
- [Guide 2: GPU/VRAM Errors](/guides/gpu-errors)
