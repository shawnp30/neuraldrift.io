...
![Portable](https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=80&w=2020&auto=format&fit=crop)
...
**Ready to install?**  
→ [Installation Guide - Portable Section](/guides/installation)

**Want to compare with Desktop?**  
→ [Decision Guide](/guides/portable-vs-desktop)

**Curious about Desktop install?**  
→ [Why Choose Desktop Install](/guides/why-choose-desktop)
