...
> 💡 **Repo Integration** — Always store your `.json` version of this flow in the `/workflows/` folder of this repository for easy access across devices.
...
> ⚡ **Trigger Action** — Automate your triggers. When a user uploads a photo to your site, your backend can automatically inject that image path into the "Load Image" node of your ComfyUI workflow.
