      ...
      <main className="pt-24 pb-20 px-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 gap-4 mb-12">
          {[
            ...
            { step: "02", label: "Select hardware profile", desc: "8GB / 12GB / 16GB / 24GB â€” settings auto-adjust" },
            ...
            <Link key={wf.id} href={`/workflows/${wf.id}`}
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border">
                <div className="font-mono text-xs text-muted">
                  {wf.requiredModels.filter(m => m.required).length} required models Â·{" "}
          ...
          <div className="grid grid-cols-2">
            <div className="p-10 border-r border-accent-purple/15">
              ...
              <p className="text-muted mb-6 text-sm leading-relaxed">
                ComputeAtlas is an AI workstation planning platform. Use it to spec the exact hardware you need â€” GPU, CPU, RAM, storage â€” before you buy.
              </p>
            ...
            <div className="p-10">
              ...
              <div className="space-y-3">
                {[
                  { name: "Creator AI Rig", spec: "1Ã— RTX 4090 Â· Ryzen 9 9950X Â· 64GB RAM", href: "https://computeatlas.ai/recommended-builds", tag: "Image & Video" },
                  { name: "Fine-Tuning Workstation", spec: "2Ã— RTX 6000 Ada Â· Threadripper PRO", href: "https://computeatlas.ai/recommended-builds", tag: "Training" },
                ].map((b) => (
