...
export default function ProofUploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setStatus({
        type: "success",
        msg: `✓ Uploaded! Live at /proof — visible on the gallery page.`,
      });
      ...
      <div style={S.container}>
        ...
        <div style={{ marginBottom: "2.5rem" }}>
          ...
          >
            Upload your
            <br />
            <span style={{ color: "#f59e0b" }}>workflow outputs.</span>
          </h1>
          <p
            style={{
              color: "#9aafc0",
        ...
        >
          ...
          then add the token in your Vercel dashboard → Project Settings →
        ...
        <div style={S.card}>
                  ...
                  style={{
                    background:
                      categoryFilter === cat
                        ...
                        : "transparent",
                    border: `1px solid ${categoryFilter === cat ? "rgba(245,158,11,0.4)" : "rgba(255,255,255,0.08)"}`,
                    color: categoryFilter === cat ? "#f59e0b" : "#7a8a9a",
                    fontFamily: "var(--font-jetbrains-mono)",
                    fontSize: 10,
                    padding: "3px 9px",
                    borderRadius: 4,
            ...
            >
              {preview ? (
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 14, color: "#9aafc0", marginBottom: 4 }}
                  >
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            <input
              style={S.input}
              placeholder="Describe the prompt or settings used..."
              value={caption}
          ...
          <div style={{ display: "flex", gap: "0.75rem" }}>
            <button
              ...
              disabled={uploading || !file || !selectedWorkflow}
              style={{
                ...S.btn,
                opacity: uploading || !file || !selectedWorkflow ? 0.5 : 1,
                cursor:
                  uploading || !file || !selectedWorkflow
                    ? "not-allowed"
                    : "pointer",
                display: "flex",
                alignItems: "center",
