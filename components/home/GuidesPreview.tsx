...
const GUIDES = [
  ...
  { slug: "model-types", difficulty: "Advanced", title: "Stable Diffusion Model Types Explained", desc: "Compare model families and choose a starting point without treating estimates as guarantees.", time: "6 min", tag: "Models" },
];
