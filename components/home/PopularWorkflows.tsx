...
const WORKFLOWS = [
  {
    ...
    desc: "Gold-standard open-source image quality. Portrait, cinematic, and editorial. 16GB VRAM.",
    category: "Image / Flagship",
    tagColor: "bg-blue-500/15 text-blue-400 border-blue-500/25",
    glowColor: "from-blue-500/20",
    image: "/workflow-thumbs/01.png",
    href: "/workflows/01",
  },
  {
    title: "SDXL Base + Refiner",
    desc: "Two-pass pipeline. Base generates the latent, Refiner adds fine detail at 1024px.",
    category: "Image / Pro",
    tagColor: "bg-cyan-500/15 text-cyan-400 border-cyan-500/25",
    glowColor: "from-cyan-500/20",
    image: "/workflow-thumbs/03.png",
    href: "/workflows/03",
  },
  {
...
export const PopularWorkflows = () => {
  return (
    <section className="relative overflow-hidden border-t border-white/5 bg-transparent py-20">
