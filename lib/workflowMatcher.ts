...
const REGISTRY: WorkflowMatch[] = [
  // ── IMAGE WORKFLOWS ────────────────────────────────────────────────────────
  {
    ...
    estimatedTime: "45s/img",
    guideSlug: "comfyui-complete-setup",
  },
  {
    id: "02",
    filename: "02-flux-schnell-fast",
    ...
    tags: ["image"],
    difficulty: "Beginner",
    estimatedTime: "8s/img",
  },
  {
    id: "03",
    filename: "03-sdxl-standard",
    name: "SDXL Standard",
    ...
    tags: ["image"],
    difficulty: "Beginner",
    estimatedTime: "20s/img",
  },
  {
    id: "06",
    filename: "06-sd15-classic",
    name: "SD 1.5 Classic",
    ...
    tags: ["image"],
    difficulty: "Beginner",
    estimatedTime: "12s/img",
  },
  {
    id: "30",
    filename: "30-flux-portrait-v2",
    ...
    tags: ["image"],
    difficulty: "Intermediate",
    estimatedTime: "55s/img",
    guideSlug: "comfyui-complete-setup",
  },
  {
    id: "40",
    filename: "40-flux-realistic-person",
    ...
    tags: ["image"],
    difficulty: "Intermediate",
    estimatedTime: "50s/img",
  },
  {
    id: "39",
    filename: "39-sdxl-concept-art",
    ...
    tags: ["image"],
    difficulty: "Beginner",
    estimatedTime: "25s/img",
  },
  // ── VIDEO WORKFLOWS ────────────────────────────────────────────────────────
  {
    id: "12",
    filename: "12-ltx-video-cinematic",
    ...
    tags: ["video"],
    difficulty: "Intermediate",
    estimatedTime: "3–5 min/clip",
    guideSlug: "ltx-video-cinematic-action",
  },
  {
    id: "13",
    filename: "13-ltx-video-action-chase",
    ...
    tags: ["video"],
    difficulty: "Advanced",
    estimatedTime: "4–6 min/clip",
    guideSlug: "ltx-video-cinematic-action",
  },
  {
    id: "14",
    filename: "14-ltx-video-fast-draft",
  ...
  },
  {
    ...
    tags: ["video"],
    difficulty: "Beginner",
    estimatedTime: "2 min/clip",
  },
  {
    id: "16",
    filename: "16-animatediff-character",
    ...
    tags: ["video"],
    difficulty: "Intermediate",
    estimatedTime: "3 min/clip",
  },
  // ── LORA WORKFLOWS ─────────────────────────────────────────────────────────
  {
    id: "07",
    filename: "07-flux-lora-character",
  ...
  },
  {
    ...
    tags: ["lora", "image"],
    difficulty: "Intermediate",
    estimatedTime: "22s/img",
    guideSlug: "train-flux-lora",
  },
  // ── UPSCALE WORKFLOWS ──────────────────────────────────────────────────────
  {
    id: "21",
    filename: "21-upscale-4x-esrgan",
    ...
    tags: ["upscale"],
    difficulty: "Beginner",
    estimatedTime: "5s/img",
  },
  {
    id: "22",
    filename: "22-upscale-anime",
    name: "Anime Upscale",
...
export function getMatches(
  ...
  return REGISTRY.filter((w) => w.tags.includes(goal))
    .map((w) => scoreWorkflow(w, budget))
    .filter((w) => w.compatScore > 0)
    .sort(
      (a, b) => b.compatScore - a.compatScore || a.vramRequired - b.vramRequired
    )
    .slice(0, limit);
}
