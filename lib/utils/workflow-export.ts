...
function getLTXGGUFTemplate(filename: string): object {
  return {
    ...
    nodes: [
      ...
      { id: 4, type: "CLIPTextEncode", pos: [860, 370], size: [380, 140], flags: {}, order: 3, mode: 0, inputs: [{ name: "clip", type: "CLIP", link: 14 }], outputs: [{ name: "CONDITIONING", type: "CONDITIONING", links: [4] }], properties: { "Node name for S&R": "Negative Prompt" }, widgets_values: ["INJECT_NEGATIVE"] },
